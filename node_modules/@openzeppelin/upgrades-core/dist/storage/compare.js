...
class StorageLayoutComparator {
    ...
    getFieldChange(original, updated) {
        var _a, _b;
        const nameChange = !this.unsafeAllowRenames && original.label !== ((_a = updated.renamedFrom) !== null && _a !== void 0 ? _a : updated.label);
        const retypedFromOriginal = original.type.item.label === ((_b = updated.retypedFrom) === null || _b === void 0 ? void 0 : _b.trim());
